...
const Banner = () => {
    return (
        <>
            <div className=" flex flex-col gap-6 md:gap-0 md:flex-row items-center justify-center relative overflow-hidden py-5 md:py-10 max-w-[1400px] mx-auto ">
                <div className=" md:flex-1 relative">
                    ...
                    <div className="mt-4 md:mt-4 px-4 flex items-center justify-center md:justify-normal gap-6 md:gap-5 lg:gap-8 relative z-10">
                        <button className=" text-[12px] md:text-[14px] lg:text-[16px] font-semibold px-6 py-4 bg-yellow-300 border-black border-2 rounded-md flex items-center gap-3 text-black hover:py-3.5 hover:bg-transparent duration-500 ">SHOP NOW <FaArrowRight></FaArrowRight></button>
                        <button className=" text-[12px] md:text-[14px] lg:text-[16px] font-semibold px-6 py-3.5 border-2 border-black rounded-md flex items-center gap-3 hover:bg-yellow-300 hover:text-black text-black duration-500  ">EXPLORE MORE</button>
                    </div>
                    <div className=" hidden xl:grid grid-cols-2 md:grid-cols-2 xl:grid-cols-4 gap-5 p-4 lg:p-6 border-yellow-300 border-2 rounded-lg mt-5 xl:mt-14 mx-4 lg:mx-0 ">
                        ...
                        <div className=" bg-gray-100 p-2 rounded-2xl">
                            <img className="xl:h-24 mx-auto" src="https://i.ibb.co/xgTM2PM/Ds-KKCFBKX3-unscreen.gif" alt="" />
                            <h4 className="text-[14px] md:text-[16px] font-semibold text-center text-black">HIGH QUALITY</h4>
                        </div>
                    </div>
                    <div className=" w-20 h-20 mx-auto rounded-3xl transform rotate-45 border-8 border-yellow-300 bg-transparent absolute -top-1/4 xl:-top-1/4 md:-top-2/4 left-3  my-auto "></div>
                    <div className=" w-20 h-20 mx-auto rounded-3xl transform rotate-45 border-8 border-yellow-300 bg-transparent absolute -top-1/4 xl:-top-1/4 md:-top-2/4 right-3  my-auto "></div>
                </div>
                <div className=" md:flex-1 relative">
            ...
            <div className=" xl:hidden grid grid-cols-2 md:grid-cols-4 xl:grid-cols-4 gap-5 p-4 lg:p-6 border-yellow-300 border-2 rounded-lg mt-5 xl:mt-14 mx-4 md:-mt-8 ">
                <div className="bg-yellow-300 p-2 rounded-2xl ">
                ...
                <div className=" bg-gray-100 p-2 rounded-2xl">
                    <img className=" h-36 mx-auto" src="https://i.ibb.co/xgTM2PM/Ds-KKCFBKX3-unscreen.gif" alt="" />
